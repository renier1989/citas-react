    ...
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      ...
      <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-lg py-10 px-5 mb-4">
        <div>
          ...
          <input value={nombre_mascota} onChange={(e)=>setNombreMascota(e.target.value)} id="nombre_mascota" type="text" placeholder="Nombre de la Mascota" className=" border-2 w-full p-2 mt-2 placeholder:text-gray-600  rounded-md"/>
        </div>
        <div className="mt-5">
          <label htmlFor="nombre_propietario" className="block text-gray-700 uppercase font-bold">Porpietario</label>
          <input value={nombre_propietario} onChange={(e)=>setNombrePropietario( e.target.value)} id="nombre_propietario" type="text" placeholder="Nombre del Propietario" className=" border-2 w-full p-2 mt-2 placeholder:text-gray-600  rounded-md"/>
        </div>
        <div className="mt-5">
          <label htmlFor="email_propietario" className="block text-gray-700 uppercase font-bold">Email Propietario</label>
          <input value={email_propietario} onChange={(e)=>setEmailPropietario(e.target.value)} id="email_propietario" type="email" placeholder="Email del Propietario" className=" border-2 w-full p-2 mt-2 placeholder:text-gray-600  rounded-md"/>
        </div>
        <div className="mt-5">
          <label htmlFor="fecha_alta" className="block text-gray-700 uppercase font-bold">Fecha de Alta</label>
          <input value={fecha_alta} onChange={(e)=>setFechaAlta(e.target.value)} id="fecha_alta" type="date" className=" border-2 w-full p-2 mt-2 placeholder:text-gray-600  rounded-md"/>
        </div>
        <div className="mt-5">
          <label htmlFor="sintomas_mascota" className="block text-gray-700 uppercase font-bold">Sintomas</label>
          <textarea value={sintomas} onChange={(e)=>setSintomas(e.target.value)} id="sintomas_mascota" type="date" placeholder="Describe los sintomas de tu mascota" className=" border-2 w-full p-2 mt-2 placeholder:text-gray-600  rounded-md"/>
        </div>
        <div>
